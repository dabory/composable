const setting_prompt = (function ($, window, document, undefined) {
    setting_prompt_open = (limit, offset, page = 1) => {
        ...
        $.when( get_api_data(moealSetFile['General']['PageApi'], {
            ...
            let onclick;
            if( d.Page ){
                make_pagination('setting_prompt', d.PageVars.QueryCnt, page, $(id).data('class') );
                ...
                make_pagination('setting_prompt', 1, 1, $(id).data('class') );
            }
