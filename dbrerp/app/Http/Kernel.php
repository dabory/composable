...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\CheckSendingAPI::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'check.gate.token' => \App\Http\Middleware\CheckGateToken::class,
        'check.pro.member' => \App\Http\Middleware\CheckProMember::class,
        'check.company.sort' => \App\Http\Middleware\CheckCompanySort::class,
        'check.pro.guest' => \App\Http\Middleware\CheckProGuest::class,
