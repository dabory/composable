<div class="page-header page-header-light">
    <div class="page-header-content header-elements-xl-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> -
                Dashboard</h4>
            <a href="#" class="header-elements-toggle text-body d-xl-none"><i class="icon-more"></i></a>
        </div>
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-xl-inline">
        <div class="d-flex">
