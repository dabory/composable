        ...
        <div class="col-xl-12">
            <div class="mb-1 pt-2 text-right">
                ...
                <div class="btn-group" hidden>
                    <button type="button" class="btn-dark btn-sm btn-primary credit-act save-button" data-value="save" {{ $formB['FormVars']['Hidden']['SaveButton'] }}>
...
<script src="{{ csset('/js/modals-controller/b-type/common.js') }}"></script>
    <script>
            ...
            $('.credit-act').on('click', function () {
                ...
                switch( $(this).data('value') ) {
                    case 'save':
                        ...
                        btn_act_save('#credit-form #frm'); break;
        ...
        function data_init(){
            ...
            $('.credit-act.save-button').removeClass('disabled')
