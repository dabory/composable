<div class="mb-1 pt-2 text-right btn-groups item_tabbed">
    <button type="button" id="item-modal-btn"
            ...
            data-target="item"
            data-class="basic"
            data-clicked="PopupForm1FormAItemTabbedForm.fetch_item"
            data-variable="PopupForm1FormAItemTabbedForm.itemModal">
...
<div class="card p-2 item_tabbed" id="item-form">
    <button type="button" id="modal-media-btn" hidden
            class="btn btn-success btn-open-modal">
    </button>
	<div class="tabs_wrap">
		<ul class="nav nav-tabs nav-tabs-solid rounded justify-content-between my-2">
			<li class="nav-item {{ $formA['FormVars']['Display']['TabA'] }}"><a href="#anch-basic" id="basic-tab" class="nav-link active">{{ $formA['FormVars']['Title']['TabA'] }}</a></li>
			<li class="nav-item d-flex"><a href="#anch-optpro" class="nav-link">옵션</a></li>
			<li class="nav-item d-flex"><a href="#anch-thm-media" class="nav-link">추가 이미지</a></li>
			<li class="nav-item d-flex"><a href="#anch-prod-addon-ipn" class="nav-link">제공 정보</a></li>
			<li class="nav-item {{ $formA['FormVars']['Display']['TabB'] }}"><a href="#anch-badge" class="nav-link" >{{ $formA['FormVars']['Title']['TabB'] }}</a></li>
			<li class="nav-item {{ $formA['FormVars']['Display']['TabC'] }}"><a href="#anch-related" class="nav-link">{{ $formA['FormVars']['Title']['TabC'] }}</a></li>
			<li class="nav-item {{ $formA['FormVars']['Display']['TabD'] }}"><a href="#anch-revindex" class="nav-link">{{ $formA['FormVars']['Title']['TabD'] }}</a></li>
                        ...
                        <div class="card-body">
                            <div class="form-group {{ $formA['FormVars']['Display']['MainSupplier'] }} flex-column mb-3">
                                ...
                                <div class="d-flex">
                                    <input type="text" id="supplier-txt" data-id="0" class="rounded w-100 radius-r0" autocomplete="off"
                                           onkeydown="company_model_show_cell_enter_key(event, 'BB', 'PopupForm1FormAItemTabbedForm')"
                                    ...
                                    <button type="button" {{ $formA['FormVars']['Required']['MainSupplier'] === 'hidden' ? 'hidden' : '' }}
                                            class="btn-dark rounded btn-open-modal border-0 radius-l0 col-3 PopupForm1FormAItemTabbedForm company-modal-btn"
                                            data-target="company"
                                            data-clicked="PopupForm1FormAItemTabbedForm.get_override_supplier_id"
                                            data-variable="PopupForm1FormAItemTabbedForm.companyModal">
                                        <i class="icon-folder-open"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="form-group {{ $formA['FormVars']['Display']['Brand'] }} flex-column mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button type="button"
                                            class="btn-dark rounded btn-open-modal border-0 radius-l0 col-3 PopupForm1FormAItemTabbedForm etc-brand-modal-btn"
                                            data-target="setting"
                                            data-filter="code"
                                            data-class="etc-brand"
                                            data-clicked="PopupForm1FormAItemTabbedForm.get_ete_brand_id"
                                            data-variable="PopupForm1FormAItemTabbedForm.etcBrandModal">
                                        <i class="icon-folder-open"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-group {{ $formA['FormVars']['Display']['IgroupId'] }} flex-column mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <button type="button"
                                            class="btn-dark rounded btn-open-modal border-0 radius-l0 col-3 PopupForm1FormAItemTabbedForm igroup-modal-btn"
                                            data-target="setting_igroup"
                                            data-clicked="PopupForm1FormAItemTabbedForm.get_igroup_id"
                                            data-class="igroup"
                                            data-variable="PopupForm1FormAItemTabbedForm.igroupModal">
                                        <i class="icon-folder-open"></i>
                                    </button>
                                </div>
    ...
    {{--                            </select>--}}
                        ...
                        <div class="form-group d-flex flex-column mb-3">
                            ...
                            <div class="form-group {{ $formA['FormVars']['Display']['MediaId'] }} flex-column mb-2">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="btn col text-white bg-grey-700 border-grey-700 bg-grey-700-hover" id="file-upload-btn" onclick="PopupForm1FormAItemTabbedForm.upload_file(this)">
                                        {{ $formA['FormVars']['Title']['FileUpload'] }}
                                    </button>
                                    <button class="btn text-white btn-danger col-4 ml-1" onclick="PopupForm1FormAItemTabbedForm.delete_media_id('#media-id-txt', '#bd-file-url-txt')">삭제</button>
                                </div>
                            </div>
		...
		<!-- erp -->
		<div id="anch-erp" class="anch"></div>
		...
		<div id="anch-badge" class="anch"></div>
        @include('front.dabory.erp.master-data.item-badge')

		<div id="anch-related" class="anch"></div>
        @include('front.dabory.erp.master-data.item-related')

		<div id="anch-revindex" class="anch"></div>
		...
		<div id="anch-optpro" class="anch"></div>
        @include('front.dabory.erp.master-data.item-optpro')

		<div id="anch-prod-addon-ipn" class="anch"></div>
        @include('front.dabory.erp.master-data.item-prod-addon-ipn')

		<div id="anch-delivery" class="anch"></div>
...
<script src="{{ csset('/js/modals-controller/b-type/common.js') }}"></script>
    <script>
        $(document).ready(async function() {
            PopupForm1FormAItemTabbedForm.data_init()
            await PopupForm1FormAItemTabbedForm.include_blades()
            // await PopupForm1FormAItemTabbedForm.create_igroup_select_box_options();

            $('.item-act').on('click', function () {
                // console.log($(this).data('value'))
                switch( $(this).data('value') ) {
                    case 'save': PopupForm1FormAItemTabbedForm.btn_act_save(); break;
                    case 'new': PopupForm1FormAItemTabbedForm.btn_act_new(); break;
                    case 'copy': PopupForm1FormAItemTabbedForm.btn_act_copy(); break;
                    case 'del': Atype.btn_act_del('#item-form #frm', function () {
                        $('#modal-select-popup.show').trigger('list.requery');
                        $('#modal-select-popup.show').modal('hide')
                    }, 'PopupForm1FormAItemTabbedForm'); break;
                }
            });
        ...
        (function( PopupForm1FormAItemTabbedForm, $, undefined ) {
            PopupForm1FormAItemTabbedForm.formA = {!! json_encode($formA) !!}
            PopupForm1FormAItemTabbedForm.companyModal
            PopupForm1FormAItemTabbedForm.itemModal
            PopupForm1FormAItemTabbedForm.igroupModal
            PopupForm1FormAItemTabbedForm.etcBrandModal

            PopupForm1FormAItemTabbedForm.btn_act_copy = function () {
                ...
                }, 'PopupForm1FormAItemTabbedForm')
            }

            PopupForm1FormAItemTabbedForm.delete_media_id = function (media_dom_id, file_url_dom_id) {
                $(media_dom_id).val(0)
                $(file_url_dom_id).val('')
            }

            PopupForm1FormAItemTabbedForm.upload_file = function ($this) {
            ...
            PopupForm1FormAItemTabbedForm.set_company_data_to_textbox = async function (company) {
                await PopupForm1FormAItemTabbedForm.get_override_supplier_id(company.Id)

                return $('#item-form #supplier-txt')
            }

            PopupForm1FormAItemTabbedForm.btn_act_save = function () {
            ...
            PopupForm1FormAItemTabbedForm.data_init = function () {
                ...
                Atype.set_parameter_callback(PopupForm1FormAItemTabbedForm.parameter)
            ...
            PopupForm1FormAItemTabbedForm.btn_act_new = async function () {
                PopupForm1FormAItemTabbedForm.data_init()
                ...
                if (window.User['MemberId'] !== 0) {
                    await get_supplier_id(window.User['MemberBuyerId'])
                }
                $('#item-form').find('#item-code-txt').val(await make_slip_no('item-auto-create', 'item-yw'))
            }

            PopupForm1FormAItemTabbedForm.btn_act_new_callback = function () {
                ...
                PopupForm1FormAItemTabbedForm.btn_act_new()
            }

            PopupForm1FormAItemTabbedForm.show_popup_callback = async function (id) {
                if ($('#element_in_which_to_insert').find('#modal-company').length == 0) {
                    iziToast.error({
                        title: 'Error', message: '아직 로딩 중 입니다. 잠시 후 다시 시도해주세요',
                    });
                ...
                $('#item-modal-btn').prop('hidden', true)
                PopupForm1FormAItemTabbedForm.data_init()
                await PopupForm1FormAItemTabbedForm.fetch_item(Number(id));
            }

            PopupForm1FormAItemTabbedForm.include_blades = async function() {
                const company = await get_para_data('modal', '/search/company-search/supplier')
                PopupForm1FormAItemTabbedForm.companyModal = company['data']

                const item = await get_para_data('modal', '/search/item-search/item')
                PopupForm1FormAItemTabbedForm.itemModal = item['data']

                const igroup = await get_para_data('modal', '/search/setting-search/igroup')
                PopupForm1FormAItemTabbedForm.igroupModal = igroup['data']

                const etc_brand = await get_para_data('modal', '/search/setting-search/etc-brand')
                PopupForm1FormAItemTabbedForm.etcBrandModal = etc_brand['data']

                get_blades_html('front.outline.static.item', PopupForm1FormAItemTabbedForm.itemModal, function (html) {
                ...
                get_blades_html('front.outline.static.setting-igroup', PopupForm1FormAItemTabbedForm.igroupModal, function (html) {
                    if ($('#element_in_which_to_insert').find('#modal-setting-igroup.igroup').length) return;
                    $('#element_in_which_to_insert').append(html);
                }, 'moealSetFile', { modalClassName: 'igroup' });

                get_blades_html('front.outline.static.setting', PopupForm1FormAItemTabbedForm.etcBrandModal, function (html) {
                    if ($('#element_in_which_to_insert').find('#modal-setting.etc-brand').length) return;
                    $('#element_in_which_to_insert').append(html);
                }, 'moealSetFile', { modalClassName: 'etc-brand' });

                get_blades_html('front.outline.static.company', PopupForm1FormAItemTabbedForm.companyModal, function (html) {
                    if ($('#element_in_which_to_insert').find('#modal-company').length) return;
                    $('#element_in_which_to_insert').append(html);

                    const itemId = getParameterByName('id')
                    if (itemId) {
                        return PopupForm1FormAItemTabbedForm.fetch_item(Number(itemId))
                    }
            ...
            PopupForm1FormAItemTabbedForm.create_igroup_select_box_options = async function () {
            ...
            PopupForm1FormAItemTabbedForm.get_igroup_id = async function (igroup_id) {
            ...
            PopupForm1FormAItemTabbedForm.get_override_supplier_id = async function (supplier_id) {
                await get_supplier_id(supplier_id);
            }

            PopupForm1FormAItemTabbedForm.get_ete_brand_id = function (brand_name) {
                $('#item-form').find('#brand-name-txt').val(brand_name)
                $('#modal-setting.show').modal('hide');
            }

            PopupForm1FormAItemTabbedForm.parameter = function () {
            ...
            PopupForm1FormAItemTabbedForm.call_item_pick = async function(page) {
                return await get_api_data(PopupForm1FormAItemTabbedForm.formA['General']['PickApi'], {
                    ImageType: 'thumb',
                    Page: page
                })
            }

            PopupForm1FormAItemTabbedForm.fetch_item = async function (id) {
                console.log('id 받아옴 : ', id)
                const response = await PopupForm1FormAItemTabbedForm.call_item_pick([ { Id: id } ])
                console.log('fetch_item_response : ', response);
                PopupForm1FormAItemTabbedForm.set_item_ui(response)
            }

            PopupForm1FormAItemTabbedForm.set_item_ui = async function (response) {
                ...
                if (item.IgroupId !== 0) {
                    await PopupForm1FormAItemTabbedForm.get_igroup_id(item.IgroupId)
                }
        ...
        }( window.PopupForm1FormAItemTabbedForm = window.PopupForm1FormAItemTabbedForm || {}, jQuery ));
