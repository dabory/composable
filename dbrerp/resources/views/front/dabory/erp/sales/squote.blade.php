...
{{--                                            </div>--}}
                                        ...
                                        <div class="form-group d-flex flex-column mb-2">
                                            ...
                                            <input class="rounded w-100" type="date" value="" id="squote-date"
                                        ...
                                        <div class="form-group d-flex flex-column">
                                            <label class="m-0">{{ $formB['FormVars']['Title']['Input1'] }}</label>
                                            <input type="text" id="input1-txt" class="rounded w-100" autocomplete="off"
                                                   maxlength="{{ $formB['FormVars']['MaxLength']['Input1'] }}"
                                                {{ $formB['FormVars']['Required']['Input1'] }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="card card card-info mb-3 mb-md-0 border-light" style="height: 250px">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-flex flex-column">
                                            <label class="m-0 ">{{ $formB['FormVars']['Title']['VaildPeriod'] }}</label>
                                            <select class="rounded w-100" id="vaild-period-select"
                                                    maxlength="{{ $formB['FormVars']['MaxLength']['VaildPeriod'] }}"
                                                {{ $formB['FormVars']['Required']['VaildPeriod'] }}>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group d-flex flex-column">
                                            ...
                                            <select class="rounded w-100" data-closed="0" id="status-select" onchange="Btype.set_is_closed_val(this)"
                                                ...
                                                @foreach ($codeTitle['status']['squote'] as $key => $status)
                ...
                <div class="card-body p-0 mt-2 mx-2">
                    <div id="p-quote-eBody">
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="btn-group">
                                <button class="btn btn-sm btn-primary squote-bd-act disabled-if-saved" data-value="add">
...
@section('modal')
    @include('front.outline.static.slip', ['moealSetFile' => $squoteModal])
...
<script src="{{ csset('/js/modals-controller/b-type/common.js') }}"></script>
    <script>
        ...
        function btn_bd_act_body_copy(parameter_name) {
            Btype.btn_act_save('#sqoute-form #frm', async function () {
