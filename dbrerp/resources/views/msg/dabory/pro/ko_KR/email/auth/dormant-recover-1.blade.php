<table align="center" border="0" cellpadding="0" cellspacing="0" style="table-layout:fixed; max-width:700px; background-color:#fff; font-size:16px; font-family:'Roboto', 'Noto Sans KR', sans-serif;" width="100%">
 ...
 <p style="margin:0; padding:0;">{{$data['C3']}}에 다시 찾아주셔서 감사합니다.
 휴면회원 복원이 완료되었습니다.
 </td>
 </tr>
 <tr>
 <td><a href="{{$data['C11']}}" style="display:inline-block; width:220px; margin-top:40px; margin-bottom:60px; padding:15px; background-color:#0f0f3c; border-radius:50px; border:none; font-size:18px; font-family:'Roboto', 'Noto Sans KR', sans-serif; color: #ffffff; text-decoration: none; font-weight:700; text-align:center;" target="_blank">로그인하기</a></td>
 </tr>
 <tr>
