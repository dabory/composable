            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="word-break:break-word;">
                        <h1 style="margin:0; margin-left:-10px; padding:0; color:#212121; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:74px; font-weight:300; letter-spacing:-2px; line-height:1.2; word-break: break-word;"><strong>구매하신 내역</strong>을<br/> 확인해 주세요!</h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:30px; color:#666; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:16px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <p style="margin:0; padding:0;">
                            <strong>{{$data['C11']}}님</strong> {{$data['C3']}}에서 주문하신 <strong>구매내역</strong>을 안내해드립니다.<br/>
                            <em style="display:block; margin-top:6px; font-size:14px; font-style:normal; ">(쿠폰번호 SMS 전송 및 배송상태 확인은 <a href="{{$data['C12']}}" style="color:inherit; font-weight:bold;">마이페이지</a>에서 가능합니다)</em>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:20px 0; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:16px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <h5 style="margin:0; margin-bottom: 10px; font-size:18px; color:#4a4a4a; font-weight:bold">구매 정보</h5>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #333; font-size:14px;">
                            <thead>
                            <tr>
                            ...
                            @foreach($data['C50'] ?? [] as $sorderBd)
                                <tr>
                                    ...
                                    <td style="padding:8px 5px; border-bottom:1px solid #ddd; color:#666; text-align:center;">{{ number_format($sorderBd['C6']) }}원</td>
                ...
                <tr>
                    <td style="padding-top:60px; color:#787878; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:18px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <h5 style="margin:0; margin-bottom:5px; font-size:18px; color:#4a4a4a; font-weight:bold">결제 정보</h5>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #333; font-size:14px; color:#666;">
                            <tr>
                                <th style="padding:8px 5px; text-align:left; color:#525252;">주문금액</th>
                                <td style="padding:8px 5px; text-align:left; font-weight:bold; color:#b54439; font-size:18px;">{{$data['C13']}}원</td>
                            </tr>
                            <tr>
                                <th style="padding:8px 5px;  border-bottom:1px solid #ddd; text-align:left; color:#525252;">결제방법</th>
                ...
                <tr>
                    <td style="padding-top:60px; color:#787878; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:18px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <h5 style="margin:0; margin-bottom:5px; font-size:18px; color:#4a4a4a; font-weight:bold">받는사람 정보</h5>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-top:1px solid #333; font-size:14px; color:#666;">
                            <tr>
                            ...
                            <tr>
                                <th style="padding:8px 5px; border-bottom:1px solid #ddd; text-align:left; color:#525252;">주소</th>
                ...
                <tr>
                    <td style="padding:80px 0; text-align:center;">
                        <a href="{{$data['C17']}}" style="margin:0 5px; display:inline-block; width:220px; padding:15px; background-color:#0f0f3c; border-radius:50px; border:none; font-size:18px; font-family:'Roboto', 'Noto Sans KR', sans-serif; color: #ffffff; text-decoration: none; font-weight:700; text-align:center;" target="_blank">{{$data['C3']}} 상품보기</a>
                        <a href="{{$data['C18']}}" style="margin:0 5px; display:inline-block; width:220px; padding:15px; background-color:#0f0f3c; border-radius:50px; border:none; font-size:18px; font-family:'Roboto', 'Noto Sans KR', sans-serif; color: #ffffff; text-decoration: none; font-weight:700; text-align:center;" target="_blank">구매 상세정보 확인</a>
                    </td>
                </tr>
                <tr>
                    <td style="color:#787878; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:18px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <ul style="padding-left:16px; font-size:14px; color:#787878;">
                            ...
                            <li>궁금하신 점은 {{$data['C3']}}고객센터(tel.000-0000-0000)로 전화주시거나 <a href="#" style="color:#365e87;">마이페이지>고객센터</a>를 이용해 주시기 바랍니다.</li>
                ...
                <tr>
                    <td style="padding-top:20px; background-color:#f8f8f8; font-family:'Roboto', 'Noto Sans KR', sans-serif; font-size:18px; font-weight:400; line-height:1.6; word-break: break-word;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px; color:#666;">
                            <tr>
                                <td width="50%" style="padding:20px; vertical-align:top">
                                    <h4 style="margin: 0; margin-bottom: 10px; font-size:14px; color:#333;">채무 지급보증 서비스 이용</h4>
                                    고객님께서 현금 결제한 금액에 대해 당사는 우리은행과 채무 지급보증계약을 체결하여 안전거래를 보장하고 있습니다. 채무 지급보증 서비스는 고객님께서 선불로 입금하신 주문에 대해 {{$data['C3']}}이 대금 환급 의무와 상품 공급을 불이행함으로써 발생하는 피해를 우리은행이 보증하는 서비스입니다.
                                    ...
                                    <ul style="padding-left:16px;">
                                        ...
                                        <li>상품의 불량 및 오배송의 사유가 있는 경우에는 상품 수령 후 3개월 이내 또는 그 사실을 알 수 있었던 날로부터 30일 이내에 요청하실 수 있습니다.</li>
                                    ...
                                    <ul style="padding-left:16px;">
                                        ...
                                        <li>주문 확인 후 상품제작이 들어가는 주문제작상품 또는 고객님의 요청에 의해 상품사양이 변경된 경우(제작이 시작된 이후에는 취소 및 교환/반품이 불가합니다.)</li>
                                        <li>제품을 개봉하여 장착한 이후 단순변심의 경우 (예: 자동차용품 등)</li>
                                        <li>복제가 가능한 상품의 포장 등을 훼손한 경우 (예: CD/DVD/GAME/BOOK 등)</li>
                                        <li>상품의 시리얼 넘버 유출로 내장된 소프트웨어의 가치가 감소한 경우 (예: 네비게이션, CS시리얼이 적힌 PMP, 노트북, 데스크탑PC 등)</li>
                                    </ul>
                                </td>
                                <td width="50%" style="padding:20px; vertical-align:top">
                                    ...
                                    <ul style="padding-left:16px;">
                                        ...
                                        <li>일부 상품의 경우, 제조사의 사정(신모델 출시 등) 및 부품 가격변동 등에 의해 가격이 변동될 수 있으며, 이로 인한 반품 및 가격보상은 불가합니다.</li>
                                        ...
                                        <li>일부상품은 트러블(알러지, 붉은 반점, 가려움, 따가움) 발생시 진료확인서 및 소견서를 증빙하셔야 환불이 가능합니다. 이 경우, 기타 제반비용은 고객님께서 부담하셔야 합니다.</li>
                                    </ul>
                                    ...
                                    <ul style="padding-left:16px;">
                                        ...
                                        <li>이 경우, 당사가 고객님께 재화 등의 환급을 지연할 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연 이자율을 곱하여 산정한 지연이자를 지급합니다.</li>
                                    ...
                                    <h5 style="margin:3px 0;  font-size:12px; color:#333;">소비자피해보상의 처리, 재화등에 대한 불만 처리 및 소비자와 사업자 사이의 분쟁 처리에 관한 사항</h5>
                                    <ul style="padding-left:16px;">
                                        ...
                                        <li>당사는 고객님으로부터 제출되는 불만사항 및 의견은 우선적으로 그 사항을 처리합니다. 다만 신속한 처리가 곤란한 경우에는 고객님께 그 사유와 처리 일정을 즉시 통보합니다.</li>
